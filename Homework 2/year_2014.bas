...
' This following part of the code is to name the columns
    ...
    For i = 1 To ticker_lst.count
        ...
        Cells(i + 1, 12) = Application.WorksheetFunction.SumIf(Range("A2:A705714"), ticker_lst(i), Range("G2:G705714"))
        
        start_date_lst.Add (Application.WorksheetFunction.MinIfs(Range("B2:B705714"), Range("A2:A705714"), ticker_lst(i)))
        end_date_lst.Add (Application.WorksheetFunction.MaxIfs(Range("B2:B705714"), Range("A2:A705714"), ticker_lst(i)))
...
'            Else
    ...
    Set cond_format = Worksheets("2014").Range("J2:J2836")
