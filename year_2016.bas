...
' This following part of the code is to name the columns
    ...
    Dim sh As Worksheet
    Set sh = ThisWorkbook.Sheets("2016")
    Dim k As Long
    ...
    For i = 1 To ticker_lst.count
        ...
        Cells(i + 1, 12) = Application.WorksheetFunction.SumIf(Range("A2:A797711"), ticker_lst(i), Range("G2:G797711"))
        
        start_date_lst.Add (Application.WorksheetFunction.MinIfs(Range("B2:B797711"), Range("A2:A797711"), ticker_lst(i)))
        end_date_lst.Add (Application.WorksheetFunction.MaxIfs(Range("B2:B797711"), Range("A2:A797711"), ticker_lst(i)))
...
'            Else
    ...
    Set cond_format = Worksheets("2016").Range("J2:J3169")
